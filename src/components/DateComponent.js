...
import getDates from './GetDateComponent';
...
class Date extends Component {
    constructor(props) {
        super(props);
        this.state = { date: null, selectedDate: "2019-08-02" };
    }
            ...
            <div>
                ...
                <DropdownDate
                    ...
                    endDate={                           // optional, if not provided current date is endDate
                        '2019-12-31'                    // 'yyyy-mm-dd' format only
                    }
                    selectedDate={                      // optional
                        this.state.selectedDate         // 'yyyy-mm-dd' format only
                    }
                    order={                             // optional
                        ['month', 'year', 'day']        // Order of the dropdowns
                    }
